...
import { ProviderCardImagesGalleryWidget }
  from '@/app/[locale]/(tenants)/provider/cards/(widgets)/ProviderCardImagesGalleryWidget';
import { toast }
  from 'react-toastify';
...
export function ProviderCardsListWidget() {
  ...
  const fetchCards = async () => {
    ...
    const response = await apiFetchHelper({ method: 'GET', url: `/api/provider/cards?page=${page}`, params: {}, body: {} });
  ...
  const handleDelete = async (cardId: number) => {
    ...
    const response = await apiFetchHelper({ method: 'DELETE', url: `/api/provider/cards/delete/${cardId}`, params: {}, body: {} });
