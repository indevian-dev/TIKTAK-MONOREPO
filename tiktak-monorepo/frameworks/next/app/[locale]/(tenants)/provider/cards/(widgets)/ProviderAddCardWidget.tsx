...
import { ProviderLocationPickerWidget }
  from '@/app/[locale]/(tenants)/provider/ui/ProviderLocationPickerWidget';
import { ProviderCategorySelectorWidget }
  from '@/app/[locale]/(tenants)/provider/cards/(widgets)/ProviderCategorySelectorWidget';
import { ProviderOptionsSelectorWidget }
  from '@/app/[locale]/(tenants)/provider/cards/(widgets)/ProviderOptionsSelectorWidget';
...
import { ProviderImagesEditWidget }
  from '@/app/[locale]/(tenants)/provider/cards/(widgets)/ProviderImagesEditWidget';
import { ProviderVideoEditWidget }
  from '@/app/[locale]/(tenants)/provider/cards/(widgets)/ProviderVideoEditWidget';
