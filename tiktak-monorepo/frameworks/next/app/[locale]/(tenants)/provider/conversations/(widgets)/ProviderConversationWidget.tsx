...
import { ProviderMessageBubbleWidget }
  from '@/app/[locale]/(tenants)/provider/conversations/(widgets)/ProviderMessageBubbleWidget';
import { ProviderConversationChatInputWidget }
  from '@/app/[locale]/(tenants)/provider/conversations/(widgets)/ProviderConversationChatInputWidget';
import { ProviderConversationTypingIndicatorWidget }
  from '@/app/[locale]/(tenants)/provider/conversations/(widgets)/ProviderConversationTypingIndicatorWidget';
