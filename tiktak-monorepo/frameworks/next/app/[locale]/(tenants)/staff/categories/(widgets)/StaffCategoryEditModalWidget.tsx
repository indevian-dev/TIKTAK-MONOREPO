...
import { StaffCategoryIconUploadWidget }
  from '@/app/[locale]/(tenants)/staff/categories/(widgets)/StaffCategoryIconUploadWidget';
import { StaffCategoryFiltersEditWidget }
  from '@/app/[locale]/(tenants)/staff/categories/(widgets)/StaffCategoryFiltersEditWidget';
...
export function StaffCategoryEditModalWidget({ categoryId, isOpen, onClose }: StaffCategoryEditModalWidgetProps) {
  ...
  useEffect(() => {
    const fetchCategory = async () => {
      ...
      try {
        const response = await apiFetchHelper({ method: 'GET', url: '/api/staff/categories/' + categoryId, params: {}, body: {} });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const response = await apiFetchHelper({ method: 'PUT', url: '/api/staff/categories/update', params: {}, body: { categoryId, updatedCategory } });
