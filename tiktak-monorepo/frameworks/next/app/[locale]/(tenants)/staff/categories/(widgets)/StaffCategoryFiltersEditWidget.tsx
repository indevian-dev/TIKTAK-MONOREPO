...
import type { CategoryFilterRow, CategoryFilterOptionRow } from '@/types/resources/category/categoryDb';
...
export function StaffCategoryFiltersEditWidget({ categoryId }: StaffCategoryFiltersEditWidgetProps) {
    ...
    const fetchFilters = async () => {
        try {
            const response = await apiFetchHelper({ method: 'GET', url: '/api/staff/categories/' + categoryId + '/filters', params: {}, body: {} });
    ...
    const addFilter = async () => {
        try {
            const response = await apiFetchHelper({ method: 'POST', url: '/api/staff/categories/' + categoryId + '/filters/create', params: {}, body: { title: newFilterTitle, title_en: newFilterTitleEn, title_ru: newFilterTitleRu, type: filterType } });
    ...
    const deleteFilter = async (filterId: number) => {
        try {
            const response = await apiFetchHelper({ method: 'DELETE', url: '/api/staff/categories/' + categoryId + '/filters/' + filterId + '/delete', params: {}, body: {} });
    ...
    const addOption = async () => {
        try {
            const response = await apiFetchHelper({ method: 'POST', url: '/api/staff/categories/' + categoryId + '/filters/' + selectedFilterId + '/options/create', params: {}, body: { title: newOptionTitle, title_en: newOptionTitleEn, title_ru: newOptionTitleRu } });
    ...
    const deleteOption = async (optionId: number) => {
        try {
            const response = await apiFetchHelper({ method: 'DELETE', url: '/api/staff/categories/' + categoryId + '/filters/' + selectedFilterId + '/options/' + optionId + '/delete', params: {}, body: {} });
