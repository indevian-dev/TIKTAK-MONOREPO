...
import { StaffMailServiceStatusWidget }
  from '@/app/[locale]/(tenants)/staff/mail/(widgets)/StaffMailServiceStatusWidget'
import { StaffEmailSenderWidget }
  from '@/app/[locale]/(tenants)/staff/mail/(widgets)/StaffEmailSenderWidget'
import { StaffMailConfigurationWidget }
  from '@/app/[locale]/(tenants)/staff/mail/(widgets)/StaffMailConfigurationWidget'
