...
import { StaffSearchMappingsWidget }
  from '@/app/[locale]/(tenants)/staff/open-search/(widgets)/StaffSearchMappingsWidget';
import { StaffSearchStatsWidget }
  from '@/app/[locale]/(tenants)/staff/open-search/(widgets)/StaffSearchStatsWidget';
import { apiFetchHelper }
  from '@/lib/helpers/apiCallForSpaHelper';
import { StaffSearchSyncWidget }
  from '@/app/[locale]/(tenants)/staff/open-search/(widgets)/StaffSearchSyncWidget';
