...
export function PublicSingleCategoryWidget({ category }: PublicSingleCategoryWidgetProps) {
    ...
    const findParentCategory = (categories: Category[], targetId: number, parent: Category | null = null): Category | null | undefined => {
    ...
    return (
        <div className="bg-white rounded-lg max-w-7xl mx-auto">
            <h1 className="text-lg font-semibold text-dark my-2 px-4">{category.title}</h1>
