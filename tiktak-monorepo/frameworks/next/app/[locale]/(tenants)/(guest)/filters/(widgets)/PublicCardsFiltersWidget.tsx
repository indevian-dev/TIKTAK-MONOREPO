        ...
        <div className={`filter-section ${className} flex flex-col gap-4 mb-6 w-full text-dark text-md items-start`}>
            ...
            <div className="col-span-12 flex items-center justify-between gap-4 w-full mt-4">
                <button
                    ...
                    className="flex-1 px-4 py-2 bg-brandPrimaryDarkBg hover:bg-brandPrimaryDarkBg/80 text-white font-medium rounded-lg transition-colors duration-200 border border-dark"
                >
                    {t('clear')}
                </button>
                <button
                    ...
                    className="flex-1 px-4 py-2 bg-brandPrimary hover:bg-brandPrimary/80 text-white font-medium rounded-lg transition-colors duration-200 border border-brand"
                >
                    {t('apply')}
                </button>
            </div>
