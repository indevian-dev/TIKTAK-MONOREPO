...
import { PublicLeadFormWidget }
    from '@/app/[locale]/(tenants)/(guest)/(widgets)/PublicLeadFormWidget';


const PublicMapBoxWidget = dynamic(() => import('@/app/[locale]/(tenants)/(guest)/(widgets)/PublicMapBoxWidget'), { ssr: false });
                        ...
                        <div className="">
                            ...
                            <p>
                                <a
                                    ...
                                    className="dark:text-body-color-dark mb-1 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                                >
