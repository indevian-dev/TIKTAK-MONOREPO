...
import { PublicMapCardDetailModalWidget } from '@/app/[locale]/(tenants)/(guest)/map/(widgets)/PublicMapCardDetailModalWidget';
    ...
    useEffect(() => {
        ...
        try {
            dataToUse.forEach(item => {
                ...
                markerContent.style.backgroundColor = isBucket ? '#dc2626' : '#0f172a';
                ...
                markerContent.addEventListener('mouseenter', () => {
                    ...
                    markerContent.style.backgroundColor = 
                      isBucket ? '#b91c1c' : '#1e40af';
                });

                markerContent.addEventListener('mouseleave', () => {
                    markerContent.style.transform = 'scale(1)';
                    markerContent.style.backgroundColor = 
                      isBucket ? '#dc2626' : '#0f172a';
                });
                      ...
                      rounded-lg shadow-md text-sm z-10'>
                        <div className="flex items-center gap-2">
                            {buckets && buckets.length > 0 ? (
                                ...
                                <>
                                    <span className="w-3 h-3 
                                      bg-brandPrimary rounded-full"></span>
