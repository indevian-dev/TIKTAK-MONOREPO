...
import { PublicBreadCrumbsTile } from '@/app/[locale]/(tenants)/(guest)/(tiles)/PublicBreadCrumbsTile';
import { PublicAddCardToFavoritesWidget } from '@/app/[locale]/(tenants)/(guest)/cards/(widgets)/PublicAddCardToFavoritesWidget';
import { PublicMessageButtonTile } from '@/app/[locale]/(tenants)/(guest)/cards/(tiles)/PublicMessageButtonTile';
import { PublicSingleMarkerMapWidget } from '@/app/[locale]/(tenants)/(guest)/(widgets)/PublicSingleMarkerMapWidget';

// Import the Location type from the map widget to avoid conflicts
type MapLocation = { lat: number; lng: number };
import { Link } from '@/i18n/routing';
import { PublicCardGalleryWidget } from '@/app/[locale]/(tenants)/(guest)/cards/(widgets)/PublicCardGalleryWidget';
import { PublicRelatedCardsWidget } from '@/app/[locale]/(tenants)/(guest)/cards/(widgets)/PublicRelatedCardsWidget';
