...
class Logger implements LoggerInstance {
  ...
  error(message: string, metaOrError?: Error | Record<string, any>, metadata?: Record<string, any>): void {
  ...
  fatal(message: string, metaOrError?: Error | Record<string, any>, metadata?: Record<string, any>): void {
    const meta = metaOrError instanceof Error
      ? { error: metaOrError, ...metadata }
      : metaOrError || {};
