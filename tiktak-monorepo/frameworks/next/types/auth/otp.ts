...
import type { OtpType as DbOtpType } from '@/types/resources/user/user';
...
export { OtpType } from '@/types/resources/user/user';
export type { OtpType as OtpTypeEnum } from '@/types/resources/user/user';
