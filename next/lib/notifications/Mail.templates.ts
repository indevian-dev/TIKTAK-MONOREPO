import type { EmailTemplate } from '@/lib/notifications/Notification.types';
  ...
  <div class="container">
    <div class="header">
      <div class="logo-container">
        <img src="https://tiktak.az/maillogo.png" alt="TIKTAK.AZ" width="280" style="display: inline-block; height: auto;">
      </div>
    </div>
    <div class="content">
    ...
    <div class="footer">
      <p><strong>tiktak.az</strong></p>
      <p>Your trusted guide for educational institutions</p>
      <p style="margin-top: 15px;">Contact: support@tiktak.az</p>
      <p>Visit us: <a href="https://tiktak.az" style="color: #73C816; text-decoration: none;">www.tiktak.az</a></p>
      <p style="margin-top: 15px; font-size: 11px;">This is an automated message, please do not reply to this email.</p>
      <p style="font-size: 11px;">&copy; ${new Date().getFullYear()} tiktak.az. All rights reserved.</p>
    </div>
  </div>
</body>
</html>`
...
export function generateOtpEmail({
  ...
  return generateGlobalEmail({
    ...
    body: [
      ...
      { type: 'general', content: 'Thank you,<br>The tiktak.az Team' }
    ]
  });
}
...
export function generateWelcomeEmail({ username }: { username: string }): EmailTemplate {
  ...
  return generateGlobalEmail({
    title: 'Welcome to tiktak.az!',
    username: username,
    body: [
      { type: 'boldBig', content: 'Welcome to tiktak.az!' },
      { type: 'general', content: `Hello ${username},` },
      { type: 'general', content: 'Thank you for joining tiktak.az! Your account has been successfully created and verified.' },
      ...
      { type: 'general', content: 'Best regards,<br>The tiktak.az Team' }
    ]
  });
}
...
export function generateCardApprovalEmail({
  ...
  return generateGlobalEmail({
    title: 'Your Listing Has Been Approved - tiktak.az',
    username: username,
    body: [
      ...
      { type: 'general', content: 'Your listing is now live and visible on the tiktak.az platform.' },
      { type: 'general', content: 'You can view and manage your listing from your dashboard.' },
      { type: 'general', content: 'Thank you for choosing tiktak.az,<br>The tiktak.az Team' }
    ]
  });
}
...
export function generateCardRejectionEmail({
  ...
  return generateGlobalEmail({
    title: 'Listing Update Request - tiktak.az',
    username: username,
    body: [
      ...
      { type: 'general', content: 'Thank you for your understanding,<br>The tiktak.az Team' }
    ]
  });
}
