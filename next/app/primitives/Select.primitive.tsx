...
export function SelectPrimitive({
    ...
    // Derive selected values directly from the value prop — no internal state duplication
    const selectedMulti: any[] = Array.isArray(value) ? value : []
    const selectedSingle: string | number = (value as string | number) || ""
