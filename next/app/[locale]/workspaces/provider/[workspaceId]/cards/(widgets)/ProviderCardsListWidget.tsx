...
import { ProviderCardImagesGalleryWidget }
  from '@/app/[locale]/workspaces/provider/[workspaceId]/cards/(widgets)/ProviderCardImagesGalleryWidget';
import { toast }
  from 'react-toastify';
...
// API response type extending domain Card.PrivateAccess with API-specific fields
interface ProviderCardApiResponse extends Omit<Card.PrivateAccess, 'images'> {
...
export function ProviderCardsListWidget() {
  ...
  const fetchCards = async () => {
    ...
    const response = await apiCallForSpaHelper({ method: 'GET', url: `/api/provider/cards?page=${page}`, params: {}, body: {} });
  ...
  const handleDelete = async (cardId: number) => {
    ...
    const response = await apiCallForSpaHelper({ method: 'DELETE', url: `/api/provider/cards/delete/${cardId}`, params: {}, body: {} });
