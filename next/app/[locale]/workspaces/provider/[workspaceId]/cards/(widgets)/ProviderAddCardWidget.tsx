...
import { ProviderLocationPickerWidget }
  from '@/app/[locale]/workspaces/provider/[workspaceId]/ui/ProviderLocationPickerWidget';
import { ProviderCategorySelectorWidget }
  from '@/app/[locale]/workspaces/provider/[workspaceId]/cards/(widgets)/ProviderCategorySelectorWidget';
import { ProviderOptionsSelectorWidget }
  from '@/app/[locale]/workspaces/provider/[workspaceId]/cards/(widgets)/ProviderOptionsSelectorWidget';
...
import { ProviderImagesEditWidget }
  from '@/app/[locale]/workspaces/provider/[workspaceId]/cards/(widgets)/ProviderImagesEditWidget';
import { ProviderVideoEditWidget }
  from '@/app/[locale]/workspaces/provider/[workspaceId]/cards/(widgets)/ProviderVideoEditWidget';
...
export function ProviderAddCardWidget() {
  ...
  const handleCategoryChange = useCallback((path: number[]) => {
  ...
  return (
    <section className='max-w-7xl m-auto flex flex-wrap bg-white relative'>
      <div className='w-full lg:w-2/3 flex flex-wrap items-start justify-start p-4 relative'>
        {isProcessing ? (
          ...
          <div className="flex my-4 items-center">
            <input
              ...
              className="h-6 w-6 text-brandPrimary border border-gray-200-gray-300 rounded focus:ring-brand"
            />
            <label htmlFor="termsCheckbox" className="ml-2 block text-lg text-gray-900">
              ...
              {translations.accept}
              <Link href="/docs/rules" className="text-brandPrimary hover:text-brandPrimary mx-5">
                {translations.rules}
              </Link>
            </label>
          </div>
        ...
        <button
          type="button"
          className='my-4 w-full bg-brandPrimaryDarkBg hover:bg-brandPrimary text-brandPrimaryLightText border border-gray-200-slate-900 border-gray-200-2 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline'
        ...
        <button
          ...
          className={`w-full font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ${
            isProcessing 
              ...
              : 'bg-brandPrimary text-brandPrimaryLightText hover:bg-opacity-90'
          }`}
