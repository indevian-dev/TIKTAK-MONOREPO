...
export default function ProviderEditCardWidget({ cardId }: ProviderEditCardWidgetProps) {
  ...
  return (
    <section className="w-full min-h-screen flex flex-wrap items-start justify-start p-4 bg-brandPrimaryLightBg">
      <div className='w-full lg:w-2/3 flex flex-wrap items-start justify-start p-4 relative'>
        ...
        <div className="flex space-x-4 w-full">
          <button
            type="submit"
            className="flex-1 bg-brandPrimary hover:bg-brandPrimary-dark text-brandPrimaryLightText font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
