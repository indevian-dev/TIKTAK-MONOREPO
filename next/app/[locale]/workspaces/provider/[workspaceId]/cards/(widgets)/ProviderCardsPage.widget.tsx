...
import { ProviderCardsListWidget }
  from '@/app/[locale]/workspaces/provider/[workspaceId]/cards/(widgets)/ProviderCardsList.widget';
    ...
    <div className="container mx-auto px-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          ...
          className="bg-app-bright-purple text-white px-4 py-2 rounded-primary hover:bg-app-bright-purple/80"
        >
          {t('create_card')}
        </Link>
      </div>
