...
import { StaffCardsFiltersWidget }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/cards/(widgets)/StaffCardsFiltersWidget';
import { StaffCardListItemWidget }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/cards/(widgets)/StaffCardListItemWidget';
import { toast }
  from 'react-toastify';
