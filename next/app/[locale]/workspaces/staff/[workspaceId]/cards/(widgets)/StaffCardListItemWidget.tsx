...
import { StaffCardDetailsModalWidget }
    from '@/app/[locale]/workspaces/staff/[workspaceId]/cards/(widgets)/StaffCardDetailsModalWidget';
import { toast }
    from 'react-toastify';
...
interface StaffCardListItemApiResponse extends Omit<Card.PrivateAccess, 'images' | 'video' | 'store_id' | 'price'> {
...
interface StaffCardDetailsApiResponse extends Omit<Card.PrivateAccess, 'images' | 'video' | 'price'> {
  ...
  categories?: number[]; // API includes category IDs
...
export function StaffCardListItemWidget({
    ...
    return (
        <div key={card.id} className="relative p-4 rounded w-full bg-brandPrimaryLightBg/50">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <div className='text-lg text-slate-900 font-bold'>${card.price?.amount || 0}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex justify-end pt-4 border-t border-gray-200">
                <button
                    ...
                    className={`text-white py-2 px-6 rounded-md transition-colors bg-brandPrimaryDarkBg`}
                >
