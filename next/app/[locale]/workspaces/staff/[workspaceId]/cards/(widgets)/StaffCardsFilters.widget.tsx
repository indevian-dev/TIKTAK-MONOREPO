...
export function StaffCardsFiltersWidget({ onFiltersChange }: StaffCardsFiltersWidgetProps) {
  ...
  return (
    <div className="bg-app-bright-purple/10 p-4 rounded shadow-sm mb-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-slate-900">Filters</h3>
        <button
          onClick={clearFilters}
          className="text-sm bg-gray-900 text-white hover:bg-app-bright-purple/80 font-bold py-2 px-3 rounded-full"
        >
          Clear Filters
        </button>
      </div>
