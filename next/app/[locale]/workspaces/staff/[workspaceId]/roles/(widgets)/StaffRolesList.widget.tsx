                        ...
                        roles.map((role) => (
                            <div key={role.id} className="grid grid-cols-5 py-4 px-4 hover:bg-gray-50 text-black">
                                ...
                                <div className="w-1/4 text-gray-500">
                                    {role.permissions.filter((permission) => permission.startsWith('page')).length} permissions
                                </div>
                                <div className="w-1/4 text-gray-500">
                                    {role.permissions.filter((permission) => permission.startsWith('api')).length} permissions
                                </div>
