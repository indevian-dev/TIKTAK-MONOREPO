...
export function StaffUsersListWidget() {
    ...
    const handleSuspendToggle = async (accountId: string, suspended: boolean) => {
        try {
            const response = await apiCall({
                method: 'PUT',
    ...
    const handleAssignRole = (accountId: string) => {
    ...
    return (
        <div className='w-full p-4'>
            ...
            <div className="grid grid-cols-1 gap-4">
                {users.map((user) => (
                    <div key={user.id} className="bg-app-bright-purple/10 rounded p-4 grid grid-cols-2 gap-4">
