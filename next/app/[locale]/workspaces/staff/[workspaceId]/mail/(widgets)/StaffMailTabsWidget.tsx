...
import { StaffMailServiceStatusWidget }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/mail/(widgets)/StaffMailServiceStatusWidget'
import { StaffEmailSenderWidget }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/mail/(widgets)/StaffEmailSenderWidget'
import { StaffMailConfigurationWidget }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/mail/(widgets)/StaffMailConfigurationWidget'
          ...
          <nav className="-mb-px flex space-x-8">
            <button
              ...
              className={`py-2 px-1 border-b-2 font-medium text-sm ${activeTab === 'status'
                ? 'border-brand text-brandPrimary'
