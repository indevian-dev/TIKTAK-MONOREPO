...
import { StaffCategoryAddModalWidget }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/categories/(widgets)/StaffCategoryAddModalWidget';
import { StaffCategoryEditModalWidget }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/categories/(widgets)/StaffCategoryEditModalWidget';
import { StaffConfirmationModalTile }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/categories/(tiles)/StaffConfirmationModalTile';
import { StaffCategorySelectModalWidget }
  from '@/app/[locale]/workspaces/staff/[workspaceId]/categories/(widgets)/StaffCategorySelectModalWidget';
...
export function StaffCategoriesListWidget() {
  ...
  const fetchCategories = async () => {
    ...
    try {
      const response = await apiCallForSpaHelper({ method: 'GET', url: '/api/staff/categories', params: {}, body: {} });
  ...
  const deleteCategory = async () => {
    ...
    try {
      const response = await apiCallForSpaHelper({ method: 'DELETE', url: '/api/staff/categories/delete/' + selectedCategoryForDeletion, params: {}, body: {} });
