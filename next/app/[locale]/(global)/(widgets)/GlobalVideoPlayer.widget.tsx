        ...
        {!isPlaying && isVideoReady && !error && (
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 opacity-100 transition-opacity duration-300">
            <button
              ...
              className="bg-app-bright-purple hover:bg-app-bright-purple/80 text-white rounded-full p-6 transition-colors shadow-lg"
            >
              <FiPlay size={32} />
            </button>
          </div>
        ...
        <div className="bg-linear-to-t from-black/80 to-transparent p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={handlePlayPause}
                className="text-white hover:text-app-bright-purple transition-colors"
              >
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="text-white hover:text-app-bright-purple transition-colors flex items-center space-x-1"
                >
                  <BiCog size={18} />
                  ...
                  <div className="absolute bottom-full mb-2 right-0 bg-black/90 rounded-lg p-2 min-w-20">
                    {qualities.map((quality) => (
                      <button
                        ...
                        className={`block w-full text-left px-3 py-1 text-sm rounded hover:bg-app-bright-purple/20 transition-colors ${currentQuality === quality.value ? 'text-app-bright-purple' : 'text-white'
                          }`}
                      >
                        {quality.label}
                      </button>
