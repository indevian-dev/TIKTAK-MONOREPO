...
export function GlobalInlineForbiddenWidget({
  returnUrl = '/',
  title = 'Access Denied',
      ...
      <div className="max-w-md w-full space-y-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            ...
            className="px-5 py-2 bg-app-bright-purple text-white rounded-md hover:bg-app-bright-purple/90 transition-colors text-sm"
          >
            Login
          </Link>
        </div>
