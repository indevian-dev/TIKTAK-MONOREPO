...
import AuthLogoutButtonWidget
    from '@/app/[locale]/auth/logout/AuthLogoutButtonWidget';
    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center gap-2 p-2 hover:bg-brandPrimary rounded-md transition-colors"
                disabled={isLoading}
            >
                        ...
                        <>
                            <div className="p-4">
                                ...
                                <div className="space-y-2">
                                    <Link
                                        href="/auth/login"
                                        className="w-full px-4 py-3 flex items-center justify-center gap-3 bg-brandPrimary text-white rounded-md hover:bg-brandPrimary-dark transition-colors text-sm font-medium"
                                        onClick={() => setIsOpen(false)}
                                    >
