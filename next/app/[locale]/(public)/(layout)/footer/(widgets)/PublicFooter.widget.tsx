      ...
      >
        <SectionPrimitive variant="centered">
          <div className="container m-auto max-w-screen-xl">
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
                <div className="mb-12 max-w-[360px] lg:mb-16">
                  ...
                  <p className="mb-9 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                  ...
                  <div className="flex items-center">
                    <a
                      ...
                      className="dark:text-gray-500-dark mr-6 text-gray-500 duration-300 hover:text-app-bright-purple dark:hover:text-app-bright-purple"
                    >
                      <svg
                        width="9"
                        height="18"
                    ...
                    <a
                      href="/"
                      aria-label="social-link"
                      className="dark:text-gray-500-dark text-gray-500 duration-300 hover:text-app-bright-purple dark:hover:text-app-bright-purple"
                    >
                      <svg
                        width="17"
                        height="16"
              ...
              <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                <div className="mb-12 lg:mb-16">
                  <h2 className="mb-10 text-xl font-bold text-gray-900 dark:text-white">
                    {t('useful_links')}
                  </h2>
                  <ul>
                    <li>
            ...
            <div className="h-1 w-full bg-gradient-to-r from-transparent via-[#4EFFB8] to-transparent"></div>
            <div className="py-8">
          ...
          <div className="absolute right-0 top-14 z-[-1] rotate-180">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#4EFFB8" stopOpacity="0.62" />
                  <stop offset="1" stopColor="#4EFFB8" stopOpacity="0" />
                </linearGradient>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#4EFFB8" stopOpacity="0" />
                  <stop offset="1" stopColor="#4EFFB8" stopOpacity="0.51" />
                </linearGradient>
                <linearGradient
