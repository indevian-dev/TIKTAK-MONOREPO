    ...
    return (
        ...
        >
            {isLoading ? (
                ...
                isFavorite ? <PiHeartStraightFill className='text-app-bright-purple text-2xl' /> : <PiHeartStraightLight className='text-gray-900 text-2xl drop-shadow-sm drop-shadow-white' />
            )}
        </button>
    );
});
