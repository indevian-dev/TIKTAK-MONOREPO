      ...
      <div className='flex gap-2 overflow-x-auto scrollbar-hide pb-4'>
        {staticLinks.map(link => (
          <Link
            key={link.id}
            href={`/${link.slug}`}
            className={`flex-shrink-0 px-2 py-2 rounded flex items-center gap-2 relative bg-brandPrimaryLightBg text-dark hover:bg-brandPrimary hover:text-brandPrimaryLightText transition-colors duration-200 whitespace-nowrap`}
          >
