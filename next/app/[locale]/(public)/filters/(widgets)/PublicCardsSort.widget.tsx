        ...
        <>
            ...
            <button
                ...
                className={`
                    ...
                    transition-all duration-200 border bg-white text-gray-900 border-light 
                    hover:bg-app-bright-purple/10 hover:border-semilight ${className}
                `}
                    ...
                    <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                <h3 className="text-lg font-bold text-gray-900">{t('sort_options')}</h3>
                                <button
...
<label className="block text-sm font-medium text-gray-900">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-4 py-2 bg-app-bright-purple/10 hover:bg-semilight rounded-md text-sm font-medium transition-colors duration-200"
                                    >
                            ...
                            <div className="flex gap-3 pt-4 border-t">
                                {selectedSort !== defaultSort && (
                                    <button
                                        ...
                                        className="flex-1 px-4 py-2 text-sm font-medium text-app-bright-purple border border-brand rounded-md hover:bg-app-bright-purple hover:text-white transition-colors duration-200"
                                    >
                                        {t('reset_to_default')}
                                    </button>
                                )}
                                <button
                                    onClick={() => setIsModalOpen(false)}
                                    className="flex-1 px-4 py-2 text-sm font-medium bg-app-bright-purple text-white rounded-md hover:bg-app-bright-purple/90 transition-colors duration-200"
                                >
                                    {t('apply_sort')}
                                </button>
                            </div>
